...
def solve_rbc2d(Nx=21,Ny=21, Ra=2000, Pr=1,aspect=1, directsolver=False,plot=True):
    ...
    L21 = 1*WW_x       ; L22 = 1*L2d+1*WW_y   ; L23 = 1*D1y      ; L24 = -1*I*beta
...
def solve_rbc2d_neutral(Nx=21,Ny=21, Pr=1,aspect=1, directsolver=False,plot=True):
    ...
    #lhs
    L11 = 1*L2d+1*UU_x ; L12 = 1*UU_y         ; L13 = 1*D1x      ; L14 =  0*I
    L21 = 1*WW_x       ; L22 = 1*L2d+1*WW_y   ; L23 = 1*D1y      ; L24 =  0*I
    L31 = 1*D1x        ; L32 = 1*D1y          ; L33 = 0*I        ; L34 =  0*I
    L41 = 1*TT_x       ; L42 = 1*TT_y         ; L43 = 0*I        ; L44 =  1*K2d

    #rhs
    M11 = 0*I          ; M12 = 0*I     ; M13 = 0*I        ; M14 = 0*I
    M21 = 0*I          ; M22 = 0*I     ; M23 = 0*I        ; M24 = -1*I*beta
    M31 = 0*I          ; M32 = 0*I     ; M33 = 0*I        ; M34 = 0*I
    M41 = 0*I          ; M42 = 0*I     ; M43 = 0*I        ; M44 = 0*I
